...
If `user.role === "clubhouse_manager"` and `user.has_completed_onboarding === false`, the app shell SHALL redirect to `/onboarding` and not render the sidebar navigation.
